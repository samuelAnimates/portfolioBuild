...
class BreakfastProject extends Component {
	...
	projectInfo = {
		...
		synopsis:{
			...
			embed: {
				url: "https://www.youtube.com/embed/zlPJFc4O-G0?si=pSjHlIHcuJ8VRPbQ",
				title: "\"Persefone's Breakfast\" full film on YouTube."
			},
			year: "2012",
			specs: [
				{
		...
		"links": [
			{
				...
				"id": "animation0302",
				"text": "'Persefone's Breakfast' Short Film on YouTube",
